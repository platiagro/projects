...
# Erro no Notebook, Dependências adicionadas
def test_transformation_graph(setup):
    ...
    # Run test with eucalyptus dataset
    execute_notebook(experiment_path, "/dev/null", parameters=dict(dataset=EUCALYPTUS_DATASET, target=EUCALYPTUS_TARGET))
