...
DB_URL = "mysql+pymysql://{}:{}@{}/{}".format(DB_USER, DB_PASS, DB_HOST, DB_NAME)
...
def init_db():
    ...
    db_url = "mysql+pymysql://{}:{}@{}/{}".format(DB_USER, DB_PASS, DB_HOST, "mysql")
    tmp_engine = create_engine(db_url, convert_unicode=True)
    conn = tmp_engine.connect()
    text = "CREATE DATABASE IF NOT EXISTS {}".format(DB_NAME)
